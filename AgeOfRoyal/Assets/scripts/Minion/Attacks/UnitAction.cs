...
abstract public class UnitAction : ScriptableObject
{
    [Header("Global")]
    public int ID = -1; 
    public UnitAction replacedAction = null; 
...
abstract public class UnitAttack : UnitAction
{
    ...
    [SerializeField] private List<HitableEffectDamage> statuses = new List<HitableEffectDamage>();
    ...
    internal List<HitableEffectDamage> Statuses { get => statuses; set => statuses = value; }
